  ...
  <div style="padding-bottom: 20px">
    <div style="margin: 10px 0">
      <div style="width: 100%; display: flex">
        <div style="width:100%; position: relative; padding-bottom: 56.25%"> <!-- 16:9比例容器 -->
          <iframe
              style="position: absolute; width: 100%; height: 100%; border: none; border-radius: 8px"
              src="//player.bilibili.com/player.html?bvid=BV136cSeXEgw&page=1&autoplay=0&loop=1&high_quality=1"
              scrolling="no"
              frameborder="no"
